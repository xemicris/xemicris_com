...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.9.1/font/bootstrap-icons.css" link as="style" fetchpriority="low">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-rbsA2VBKQhggwzxH7pPCaAqO46MgnOM80zW1RWuH61DGLwZJEdK2Kadq2F9CUG65" crossorigin="anonymous" fetchpriority="low">
    <link type="text/css" rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700&family=Raleway:wght@400;700;900&display=swap" as="style" fetchpriority="low">
    <link rel="stylesheet" href="<?php echo RUTA ?>css/style.css" fetchpriority="low">
                ...
                <div class="offcanvas-body p-0 d-flex flex-column align-items-center">
                    ...
                    <nav id="texto-navegacion-izquierda" class="navbar-light">
                        <ul class="navbar-nav mt-5">
                            ...
                            ?>
                                <li class="barra-color">
                                    <a href="#" data-bs-target="#modal1" class="crear cambio-color nav-link px-3 active mb-3">
