 ...
 * @returns {object} div1
 */
function cadaNota(completado, urlProyecto, colorProyecto, nombreProyecto, tareas, id, comparteNota, notaOriginal, usuarioComparte = '') {
        ...
        if (respuestaProyectos[ 'proyectos' ].length > 0) {
            ...
            notas.forEach(nota => {
                ...
                if (nota[ 'completado' ] == "0" && tipoNota === 1) {
                    proyectos.appendChild(cadaNota(false, nota[ 'urlProyecto' ], nota[ 'colorProyecto' ], nota[ 'nombreProyecto' ], nota[ 'tareas' ], nota[ 'id' ], comparteNota, notaOriginal, usuarioComparte));
                    notasVacias = notasVacias + 1;
                    //notas completadas
                } else if (nota[ 'completado' ] == "1" && tipoNota === 2) {
                    proyectos.appendChild(cadaNota(true, nota[ 'urlProyecto' ], nota[ 'colorProyecto' ], nota[ 'nombreProyecto' ], nota[ 'tareas' ], nota[ 'id' ], comparteNota, notaOriginal, usuarioComparte));
                    notasVacias = notasVacias + 1;
                } else if (tipoNota === 3) {
                    const completado = (nota[ 'completado' ] == "1") ? true : false;
                    proyectos.appendChild(cadaNota(completado, nota[ 'urlProyecto' ], nota[ 'colorProyecto' ], nota[ 'nombreProyecto' ], nota[ 'tareas' ], nota[ 'id' ], comparteNota, notaOriginal, usuarioComparte));
                    notasVacias = notasVacias + 1;
                }
                usuarioComparte = '';
            })
            if (notasVacias === 0) {
                ...
                proyectos.appendChild(noHayNota());
            }
