...
<section class="practicas__contenedor">
    ...
    <div class="practicas__contenedor-secundario">
        <video class="practicas__video video-js vjs-16-9 vjs-big-play-centered" data-setup='{}' controls>
            <source src="<?php echo VIDEO . "juegoMemoria.mp4"; ?>" type="video/mp4">
        </video>
    </div>
    <div class="descarga_practicas">
        <a href="<?php echo ARCHIVOS . "encuentraLasParejas.rar"; ?>"  class="boton boton__descarga" download="EncuentraLasParejas.rar">Descargar</a>
    </div>
</section>
