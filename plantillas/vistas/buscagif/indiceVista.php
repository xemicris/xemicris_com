...
<html lang="es">
  <head>
    ...
    <meta name="description" content="Página para buscar gifs en linea">
    <link rel="shortcut icon" href="<?php echo FAVICON . "favicon.ico"; ?>">
    <title>Buscador de Gifs</title>
    <link rel="stylesheet" href="<?php echo CSS . 'buscagif.css'; ?>" type="text/css" fetchpriority="low">
  </head>
  <body>
    <div class="casa__contenedor">
      <a href="<?php echo RUTABASE . "trabajos"; ?>" title="Volver a xemicris">
    ...
    <script src="<?php echo JS . 'buscagif.js'; ?>"></script>
  </body>
</html>
